<?php class ProductDetail{
    ...
    public static function get($ProductID){
        require("connection_connect.php");
        $sql = "SELECT Product.ProductID,Product.ProductName,productdetail.MinQuantity,productdetail.MaxQuantity,productdetail.Screen,productdetail.Price FROM productdetail,product";
        $result = $conn->query($sql);
